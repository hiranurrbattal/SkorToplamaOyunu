...
namespace ConsoleCatchGame
{
    class Program
    {
        ...
        static int score = 0;
        static int targetScore = 5; // Hızlıca test etmek için 5 yaptık
        ...
        static void Main(string[] args)
        {
            ...
            Console.ResetColor(); // Renkleri normale döndür
            Console.ReadKey();
        }
        ...
        static void Draw()
        {
            ...
            // Zemin çizgisi (Oyuncunun nerede durduğunu belli eder)
            ...
            foreach (var item in items)
            {
                if (item.Y < height && item.Y > 0)
                {
                    ...
                    // * ise Sarı, O ise Camgöbeği rengi yap
        ...
        static void Input()
        {
            if (Console.KeyAvailable)
            {
                ...
                // Sınırı width - 2 yaptık ki terminalde alt satıra kayma ve takılma yapmasın
